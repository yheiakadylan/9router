...
export default function FlowAnimation() {
  ...
  return (
    <div className="mt-16 w-full max-w-4xl relative h-[360px] hidden md:flex items-center justify-center animate-[float_6s_ease-in-out_infinite]">
      {/* VIKCOM Hub - Center */}
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[160px] h-[160px] flex flex-col items-center justify-center rounded-full bg-gradient-to-br from-[#f97815]/20 via-[#f97815]/10 to-transparent border-2 border-[#f97815] shadow-[0_0_50px_rgba(249,120,21,0.3)] z-10">
        <span className="material-symbols-outlined text-4xl text-[#f97815] animate-pulse mb-1">hub</span>
